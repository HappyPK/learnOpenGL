...
const std::string VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_1\\lesson_8\\shader\\vs.shader";
const std::string FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_1\\lesson_8\\shader\\fs.shader";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, (float)glfwGetTime()*(100*i+1), glm::vec3(-1.0f, -1.0f, 0.0f));
