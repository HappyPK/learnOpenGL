...
const std::string color_VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_6\\shader\\color_vs.shader";
const std::string color_FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_6\\shader\\color_fs.shader";
const std::string light_VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_6\\shader\\light_vs.shader";
const std::string light_FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_6\\shader\\light_fs.shader";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos.x = sin(glfwGetTime() * 2) * 3;
        lightPos.y = cos(glfwGetTime() * 2) * 3;
        lightPos.z = cos(glfwGetTime() * 2) * 3;
