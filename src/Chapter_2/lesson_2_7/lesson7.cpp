...
const std::string color_VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_7\\shader\\color_vs.shader";
const std::string color_FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_7\\shader\\color_fs.shader";
const std::string light_VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_7\\shader\\light_vs.shader";
const std::string light_FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_7\\shader\\light_fs.shader";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // material properties
        mycolor_Shader->setInt("material.diffuse", 0.5);
        mycolor_Shader->setInt("material.specular", 1.0);
        mycolor_Shader->setFloat("material.shininess", 32.0f);

        //lightPos.x = sin(glfwGetTime() * 0.5) * 10;
        //lightPos.z = sin(glfwGetTime() * 0.5) * 10;
        


        mycolor_Shader->setVec3("light.position", lightPos);
        mycolor_Shader->setVec3("light.direction", camera.Front);
        mycolor_Shader->setFloat("light.cutOff", glm::cos(glm::radians(sin(glfwGetTime() * 0.6) * 22)));

        mycolor_Shader->setVec3("light.ambient", 0.2f, 0.2f, 0.2f);
        mycolor_Shader->setVec3("light.diffuse", 0.9f, 0.9f, 0.9f);
        mycolor_Shader->setVec3("light.specular", 1.0f, 1.0f, 1.0f);
        mycolor_Shader->setFloat("light.constant", 1.0f);
        mycolor_Shader->setFloat("light.linear", 0.07f);
        mycolor_Shader->setFloat("light.quadratic", 0.017f);
