...
const std::string color_VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_5\\shader\\color_vs.shader";
const std::string color_FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_5\\shader\\color_fs.shader";
const std::string light_VertexPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_5\\shader\\light_vs.shader";
const std::string light_FragmentPath = "..\\..\\..\\..\\..\\src\\Chapter_2\\lesson_2_5\\shader\\light_fs.shader";
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 light_direction(-1.2f, -1.0f, -0.3f);

        light_direction.y = cos(glfwGetTime()) * 50;
        light_direction.z = sin(glfwGetTime()) * 50;

        mycolor_Shader->setVec3("light.direction", light_direction);
